...
public class MovieService {
    ...
    public Movie Update(Integer id, Movie item) throws CustomException, ParseException {
        Movie movie = repository.findById(item.getId()).orElseThrow(() -> new CustomException("Movie wasn't found"));
        if (movie.isDeleted()) throw new CustomException("Movie wasn't found");
        SanityChecks(item);
